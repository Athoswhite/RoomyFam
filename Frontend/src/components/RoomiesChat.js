      ...
      <div className="section-title text-center mb-60 wow fadeInUp">
        ...
        <div class="flex flex-col rounded-lg bg-white shadow-lg dark:bg-neutral-700 md:flex-row ">
          ...
          <div class="flex flex-col justify-start p-6">
            ...
            We're thrilled to connect you with the right resources to help you find the perfect home. Whether you're a someone visiting Rwanda for the first time or someone in search of a new place to call home, we're here to help.
            </p>
